...
<span class="compartir">
	...
	<a target="_blank"class="zocial-facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_permalink()?>" ><img src="<?php echo get_bloginfo('template_url') ?>/img/icons/icon-social-facebook.jpg " ></a>
	<!--  -->
	...
	"><img src="<?php echo get_bloginfo('template_url') ?>/img/icons/icon-social-twitter.jpg " ></a>
	...
	"><img src="<?php echo get_bloginfo('template_url') ?>/img/icons/icon-social-pinterest.jpg " ></a>

	<a target="_blank" href="https://plus.google.com/share?url=<?php echo get_permalink() ?>"><img src="<?php echo get_bloginfo('template_url') ?>/img/icons/icon-social-google.jpg " ></a>
