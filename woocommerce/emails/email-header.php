                	...
                	<td align="center" valign="top">
						<div id="template_header_image">
                                ...
                                <p style="margin-top:0;">
                                    <img src="<?php echo $opciones['cabeceras-mails-imagen-img']?>" alt="<?php echo get_bloginfo( 'name', 'display' ) ?>" />
                                    <?php if ( key_exists('cabeceras-mails-titulo', $opciones) ):?>
                                    	<div class="encabesadoTexto">
                                    		<h2 style="text-align: center; font-size: 58px"><?php echo $opciones['cabeceras-mails-titulo'] ?> </h2>
                                    		<p style="text-align: center; font-size: 21px"><?php echo $opciones['cabeceras-mails-subtitulo'] ?></p>
                                    	</div>
                                    <?php endif; ?>
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header">
                                        <tr>
                                            <td>
                                            <?php global $cabeceraMail; ?>
                                            	<h1><?php echo $titulo = ($cabeceraMail === '') ? $email_heading : $cabeceraMail ?></h1>
                                         	   </td>
                                        </tr>
                                    </table>
                                    <!-- End Header -->
